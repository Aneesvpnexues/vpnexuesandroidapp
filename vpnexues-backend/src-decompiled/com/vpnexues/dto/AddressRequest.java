...
public class AddressRequest {
    ...
    private @NotBlank(message="Phone is required") String phone;
    @NotBlank(message="Address line 1 is required")
    private @NotBlank(message="Address line 1 is required") String addressLine1;
    ...
    public String toString() {
        return "AddressRequest(label=" + this.getLabel() + ", fullName=" + this.getFullName() + ", phone=" + this.getPhone() + ", addressLine1=" + this.getAddressLine1() + ", addressLine2=" + this.getAddressLine2() + ", city=" + this.getCity() + ", state=" + this.getState() + ", pincode=" + this.getPincode() + ", country=" + this.getCountry() + ", latitude=" + this.getLatitude() + ", longitude=" + this.getLongitude() + ", isDefault=" + this.isDefault() + ")";
    }
}
